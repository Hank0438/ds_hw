...
//    return q->size;
//}
void addQueue(int s, int t, LINK_NODE *q, int y, char type) {
...
void computerMove(LINK_NODE *q, int type, char* board[BOARD_SIZE][BOARD_SIZE]){
